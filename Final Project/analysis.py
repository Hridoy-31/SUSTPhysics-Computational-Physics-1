...
t, t1_data, t2_data, x_data_1, x_data_2, y_data_1, y_data_2, K_data, P_data  = [], [], [], [], [], [], [], [], []
E_data = []
def analysis(t, t1_data, t2_data, x_data_1, x_data_2, y_data_1, y_data_2, K_data, P_data, E_data):
    ...
    plt.plot(t, E_data, 'yellow', label = 'Total Energy')
    plt.xlabel('Time')
    plt.ylabel('Energy')
    plt.legend()
    plt.show()
...
if __name__ == '__main__':
    with open('filename.pickle', 'rb') as handle:
        ...
        t, t1_data, t2_data, x_data_1, x_data_2, y_data_1, y_data_2, K_data, P_data= b['t'], b['t1_data'] ,b['t2_data'] ,  b['x_data_1'], b['x_data_2'], b['y_data_1'], b['y_data_2'], b['K_data'], b['P_data']
    analysis(t, t1_data, t2_data, x_data_1, x_data_2, y_data_1, y_data_2, K_data, P_data)
